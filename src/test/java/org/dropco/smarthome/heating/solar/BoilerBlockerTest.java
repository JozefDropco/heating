...
//        new SolarCircularPump(new SettingsDao(),COMMAND_EXECUTOR).setState(true);
...
//        when(BoilerBlocker.BOILER_BLOCK_PIN).thenReturn("D1");
...
//        BiConsumer COMMAND_EXECUTOR = mock(BiConsumer.class);
//        new SolarCircularPump(new SettingsDao(),COMMAND_EXECUTOR).raiseChange(false);
//        new ThreeWayValve(new SettingsDao(),COMMAND_EXECUTOR).setState(true);
//        BoilerBlocker boiler = spy(new BoilerBlocker(COMMAND_EXECUTOR));
//        when(BoilerBlocker.BOILER_BLOCK_PIN).thenReturn("D1");
//        when(boiler.getCurrentDate()).thenAnswer(mock -> {
...
//        BiConsumer COMMAND_EXECUTOR = mock(BiConsumer.class);
//        new SolarCircularPump(new SettingsDao(),COMMAND_EXECUTOR).setState(false);
//        new ThreeWayValve(new SettingsDao(),COMMAND_EXECUTOR).setState(true);
//        BoilerBlocker boiler = spy(new BoilerBlocker(COMMAND_EXECUTOR));
