...
public class SolarSystemScheduler {
    ...
    public void schedule(SafetySolarPanel safetySolarPanel) {
        ...
        executorService.schedule(() -> schedule(safetySolarPanel), millisRemaining(getCalendar(), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH), calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE)), TimeUnit.MILLISECONDS);
