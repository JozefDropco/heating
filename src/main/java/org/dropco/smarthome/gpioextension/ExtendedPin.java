...
public class ExtendedPin extends PinProvider {
    public static final Pin GPIO_100 = createPin(ExtendedGpioProvider.NAME,100, "GPIO 100", EnumSet.of(PinMode.DIGITAL_OUTPUT),EnumSet.allOf(PinPullResistance.class),EnumSet.allOf(PinEdge.class));
